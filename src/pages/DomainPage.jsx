...
const DOMAINS = {
  'employment': {
    ...
    regulations: ['Fair Credit Reporting Act (FCRA)', 'Title VII of the Civil Rights Act', 'EU AI Act (high-risk classification)', 'NYC Local Law 144 (automated employment decisions)', 'OFCCP compliance requirements', 'EEOC Uniform Guidelines on Employee Selection', 'State-level AI hiring laws (IL, CO, MD, others)', 'Active litigation: Kistler v. Eightfold AI, Mobley v. Workday'],
  ...
  'financial-services': {
    ...
    regulations: ['Fair Credit Reporting Act (FCRA)', 'Equal Credit Opportunity Act (ECOA)', 'Fair Housing Act', 'Community Reinvestment Act', 'Dodd-Frank Act', 'OCC/Fed Model Risk Management (SR 11-7)', 'EU AI Act (high-risk: creditworthiness)', 'CFPB adverse action requirements'],

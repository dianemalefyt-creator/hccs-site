...
const STATIC_DOCS = [
  {
    ...
    title: 'Core Standard',
    subtitle: 'HCCS-1.0',
    desc: 'The complete governance and audit standard. 67 controls across 7 domains, with maturity levels, control classifications (MUST/SHOULD/MAY), and the governing principles that anchor every requirement.',
    details: ['7 governance domains with 67 auditable controls', 'Three-tier classification: MUST (25), SHOULD (23), MAY (19)', '5-level maturity model with Level 3 credibility threshold', 'Governing principles and standard interpretation guidance', 'Control cross-reference matrix', 'Glossary of defined terms'],

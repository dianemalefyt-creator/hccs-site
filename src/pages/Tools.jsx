    ...
    <div style={{ minHeight: '100vh', background: '#f8fafc' }}>
      <section style={{ background: 'linear-gradient(165deg, #0a1628, #1a2d4a, #0f3460)', padding: '80px 24px 60px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
          ...
          <h1 className='hero-title' style={{ fontSize: 40, fontWeight: 700, color: '#fff', margin: '0 0 16px' }}>Governance tools</h1>
      ...
      <section style={{ padding: '48px 24px 80px' }}>
        ...
        <div style={{ textAlign: 'center', marginTop: 40 }}>
          ...
          <p style={{ fontSize: 15, color: '#64748b', marginBottom: 16 }}>Want the full picture? The assessment scores all 74 controls.</p>

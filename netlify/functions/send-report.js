...
<div style="margin-top:8px;font-style:normal;color:#475569;font-size:12px">HCCS-2.0, Governing Principle</div>
</div>
...
function buildTeaserEmailHTML(user, domainScores, overallLevel, answers, gaps) {
  ...
  return '<!DOCTYPE html><html><head><meta charset="utf-8"><style>' +
    ...
    '<div style="font-size:24px;font-weight:700;color:#fff;margin-bottom:6px">$7,500</div>' +

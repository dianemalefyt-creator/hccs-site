      ...
      <section style={{ background: 'linear-gradient(165deg, #0a1628, #1a2d4a)', padding: '80px 24px 60px' }}>
        <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 17, color: '#94a3b8', maxWidth: 600, margin: '0 auto', lineHeight: 1.6 }}>
            A governance and assurance standard for consequential human decisions shaped by algorithmic systems.
          </p>
        </div>
      </section>
          ...
          <div style={{ marginBottom: 48 }}>
            ...
            <div style={{ background: '#0f172a', borderRadius: 14, padding: 28, marginTop: 24 }}>
              ...
              <p style={{ fontSize: 14, lineHeight: 1.7, color: '#94a3b8', marginBottom: 12 }}>
                A 2026 IRB-approved study with 319 participants found that giving people more transparency, more control, or better design did not change how much they trusted an AI tool. What predicted trust was who the person already was. The design intervention explained essentially nothing.
              </p>
